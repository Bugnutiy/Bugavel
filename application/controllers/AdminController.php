...
class AdminController extends Controller
{
  ...
  public function propertiesEditAction()
  {
    ...
    $vars = ['bcr' => $bcr];
    if (!empty($_POST)) {
      $product['id'] = $_POST['product_id'];   //todo сделать правильное вычисление минимальной и средней цены с учётом всех вариаций товара
      $product['min_price'] = $_POST['price'];
      $product['max_price'] = $_POST['price'];
      $product['min_price_en'] = $_POST['price'];
      $product['max_price_en'] = $_POST['price'];
      $product['average_price'] = $_POST['price'];
      $product['average_price_en'] = $_POST['price'];
      $product['quantity'] = $_POST['quantity'];

      // $product['id'] = $_POST['product_id'];   //todo сделать правильное вычисление минимальной и средней цены с учётом всех вариаций товара
      // $product['min_price'] = 0;
      // $product['max_price'] = 0;
      // $product['min_price_en'] = 0;
      // $product['max_price_en'] = 0;
      // $product['average_price'] = 0;
      // $product['average_price_en'] = 0;
      // $product['quantity'] = 0;
      
      $this->model->shop->products->Update($product);
