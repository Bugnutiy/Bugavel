          ...
          <div class="modal-body">
            <div class="row">
              <div class="mb-3 col-12 col-sm">
                ...
                <input type="text" required class="form-control" name="first_name" id="order_first_name" placeholder="<?= current($user)['lang'] == 'RU' ? 'Имя' : 'First name' ?>">
              </div>
              <div class="mb-3 col-12 col-sm">
                <label for="order_second_name" class="form-label required">Second name</label>

                <input type="text" required class="form-control" name="second_name" id="order_second_name" placeholder="<?= current($user)['lang'] == 'RU' ? 'Фамилия' : 'Second name' ?>">
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="email" required class="form-control" name="email" id="order_email" placeholder="<?= current($user)['lang'] == 'RU' ? 'Введите вашу электронную почту' : 'Type your e-mail here' ?>">
            </div>
            ...
            <div class="mb-3 phone">
              ...
              <input type="tel" class="form-control" name="phone" id="order_phone" required>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="instagram" id="order_instagram" placeholder="<?= current($user)['lang'] == 'RU' ? 'Введите вашу электронную почту' : 'Type your e-mail here' ?>">
            </div>
            ...
            <div class="mb-3 country">
              ...
              <? if (current($user)['lang'] == 'EN') : ?>
                ...
                <select name="billing_country" required id="order_billing_country" class="form-control country_select" autocomplete="country" data-placeholder="Select a country / region…" data-label="Country/Region" tabindex="-1" aria-hidden="true">
                  <option value="" hidden selected>Select a country / region…</option>
                  <option value="AF">Afghanistan</option>
                  <option value="AX">Åland Islands</option>
                  <option value="AL">Albania</option>
              ...
              <? else : ?>
                <label for="order_billing_country" class="form-label">Страна/Регион</label>
                <select name="billing_country" id="order_billing_country" class="form-control country_select" autocomplete="country" data-placeholder="Выберите страну/регион…" data-label="Страна/регион" tabindex="-1" aria-hidden="true">
                  <option value="" hidden>Выберите страну/регион…</option>
                  <option value="SZ">Eswatini</option>
                  <option value="AU">Австралия</option>
                  <option value="AT">Австрия</option>
            ...
            <div class="mb-3">
              ...
              <input type="text" required class="form-control" name="address" id="order_address" placeholder="<?= current($user)['lang'] == 'RU' ? 'Номер дома и название улицы' : 'House number and street name' ?>">
              <input type="text" class="form-control" name="apartment" id="order_apartment" placeholder="<?= current($user)['lang'] == 'RU' ? 'Крыло, подъезд, этаж и т.д. (необязательно)' : 'Apartment, suite, unit, etc. (optional)' ?>">
            </div>

            <!-- City -->
            <div class="mb-3">
              <label for="order_city" class="form-label required"><?= current($user)['lang'] == 'RU' ? 'Адрес' : 'Street Address' ?></label>
              <input type="text" class="form-control" name="city" id="order_city" placeholder="<?= current($user)['lang'] == 'RU' ? 'Город / Населенный пункт' : 'Town / City' ?>" required>

            </div>
            <!-- Region/State -->
            <div class="mb-3">
              <label for="order_region" class="form-label required"><?= current($user)['lang'] == 'RU' ? 'Регион / Область' : 'Region / State / District' ?></label>
              <input type="text" class="form-control" name="region" id="order_region" required placeholder="<?= current($user)['lang'] == 'RU' ? 'Регион / Область' : 'Region / State / District' ?>">
            </div>

            <!-- Postcode / ZIP (optional) -->
            <div class="mb-3">
              <label for="order_zip_code" class="form-label"><?= current($user)['lang'] == 'RU' ? 'Почтовый индекс (необязательно)' : 'Postcode / ZIP (optional)' ?></label>
              <input type="text" class="form-control" name="zip_code" id="order_zip_code" placeholder="<?= current($user)['lang'] == 'RU' ? 'Почтовый индекс (необязательно)' : 'Postcode / ZIP (optional)' ?>">
            </div>
            <!-- Additions -->
            <div class="mb-3">
