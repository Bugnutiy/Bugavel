      ...
      <div class="container-lg">
        <nav class="navbar navbar-expand-sm navbar-dark">
          <div class="navbar-brand" href="#">
            <span class="mail d-none d-md-inline-block me-sm-4" data-bs-toggle="tooltip" id="menu-mail" data-bs-placement="bottom" title="<?= current($user)['lang'] !== 'RU' ? 'Copy to clipboard' : 'Скопировать' ?>" onclick="emailCpy(this)">prolovi.ru@mail.ru</span>
            ...
            <a href="mailto:prolovi.ru@mail.ru" class="bi bi-envelope"></a>
          </div>
    ...
    <div class="container-lg py-4">
      <div class="row justify-content-center justify-content-md-between">
        ...
        <div class="col-12 col-sm-4 col-xl-4 persona text-end my-3">
          ...
          <p>
            <a href="mailto:prolovi.ru@mail.ru" class="e-mail">prolovi.ru@mail.ru</a>
