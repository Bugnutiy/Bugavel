<div class="row products_main">
  <div class="col-12">
    <div class="card">
      <a class="btn card-header" type="button" data-toggle="collapse" data-target="#products_collapse" aria-expanded="false" aria-controls="products_collapse"><h1>Вариации товара "<?= current($product)['name'] ?>"</h1></a>
