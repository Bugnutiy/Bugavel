<? if ($user['lang'] == 'RU') : ?>
  ...
  <p>Если вы получили это письмо по ошибке, пожалуйста, напишите об этом на info@leosmagin.com, или ответьте на это письмо</p>
...
<? else : ?>
  ...
  <p>If you received this email by mistake, please write about it at info@leosmagin.com, or reply to this email</p>
<? endif ?>