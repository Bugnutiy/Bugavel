<div class="category_goods ">
  <div class="container-lg px-3">
    ...
    <div class="row cards justify-content-around justify-content-sm-center vertical_cards">
      ...
      foreach ($products as $product_id => $product_node) : ?>
        ...
        if (!empty($product_node['properties'])) : ?>
          ...
          <? if (!empty($property_flag)) : ?>
            <div class="card-wrapper card col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2 mb-2 p-1">
              <div class="cards">
